...
simulate_scenarios_networks <- function(networks,log_alpha1, log_alpha1_pair_sd, log_phi, log_phi_pair_sd, ncases, p_pairs, all_pairs=F, dps, sim_binary, excl_improb, infile.inftime, outfile.base){
  ...
  # only keep pairs with time elapsed <18 years
